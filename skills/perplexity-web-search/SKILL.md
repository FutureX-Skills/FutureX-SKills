...
```bash
# 克隆仓库
git clone https://github.com/FutureX-Skills/FutureX-SKills.git ~/.openclaw/workspace/skills/perplexity-web-search

# 配置 Perplexity API Key
# 在 OpenClaw 配置中设置 perplexity API
```

> **前提条件**：Perplexity API Key（https://www.perplexity.ai/settings/api）
