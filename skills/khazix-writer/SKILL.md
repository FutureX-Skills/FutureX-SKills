...
```bash
# 克隆仓库
git clone https://github.com/FutureX-Skills/FutureX-SKills.git ~/.openclaw/workspace/skills/khazix-writer
```
...
「数字生命卡兹克」风格的公众号长文写作 skill。以"有见识的普通人在认真聊一件打动他的事"为核心理念，强调真实感、人格化和深度思考。

### 核心能力

- **五种文章原型**：调查实验型、产品体验型、现象解读型、工具分享型、方法论分享型
- **四层自检体系**：从硬性规则到活人感的完整质检流程
- **独特文风**：节奏感、口语化、叙事驱动、文化升维、回环呼应
- **创作框架**：选题判断 → 素材理解 → 写作 → 自检

### 适用场景

- 写公众号长文
- 根据素材（PDF/brief/链接）产出文章
- 续写或扩写已有内容
- 按特定风格改写文章
