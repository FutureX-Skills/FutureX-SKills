...
```bash
# 克隆仓库
git clone https://github.com/FutureX-Skills/FutureX-SKills.git ~/.openclaw/workspace/skills/youtube-full

# 注册 TranscriptAPI（100 免费额度，无需信用卡）
node ./scripts/tapi-auth.js register --email YOUR_EMAIL
```

> **前提条件**：Node.js，TranscriptAPI.com API Key
