...
**FutureX Skills** 是天际资本倾力打造的 AI Skills 知识库，沉淀团队在实际投资业务、内容创作、运营提效等多场景下打磨出的智能体工具集。所有 Skills 均完全开源，供社区免费使用。

> 我们相信：工具开源、知识共享，才能推动整个 VC/PE 行业进入智能化时代。

天际团队会**不定期更新**新的 Skills，欢迎 Star 关注，持续跟踪最新工具。
